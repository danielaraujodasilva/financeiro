...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        if (($_POST['action'] ?? '') === 'create') {
            ...
            $audit->log($instanceId, $auth->userId(), 'financial_transaction_create', 'financial_transactions', (string) $pdo->lastInsertId(), [], ['description' => trim($_POST['description']), 'amount' => (float) $_POST['amount']]);
